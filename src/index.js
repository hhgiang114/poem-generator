...
`;
  ...
  let poemElement = document.querySelector("#poem-part");
  poemElement.classList.remove("hidden");

  let poemPart = document.querySelector("#poem-content");
  poemPart.innerHTML = `⏳ Generating a poem about ${userInput.value}`;
